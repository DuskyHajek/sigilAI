...
const StressTestPanel = ({
  ...
  return (
    <section className="stress-panel glass-panel border border-sigil-gold/15 rounded-2xl p-5 md:p-6">
      <div className="flex flex-col gap-4">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
          <div className="min-w-0 flex-1">
            <p className="text-[10px] font-mono uppercase tracking-[0.15em] text-sigil-gold/80 mb-1">
              Counterfactual · Panel 01c
            </p>
            ...
            <p className="mt-1.5 text-xs text-slate-400 leading-relaxed max-w-3xl">
              Hypothetical &ldquo;what if&rdquo; simulator — separate from today&apos;s
              headlines and{" "}
              <span className="text-slate-300">Challenge the Thesis</span>.
              Pick a macro shock; see how all seven pillars and watchlist names
              respond through the Supernova lens.
            </p>
          </div>
        ...
        {isActive && (
          <div className="space-y-4">
            <div className="stress-result-card rounded-xl p-4">
