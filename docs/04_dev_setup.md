...
- **Challenge the Thesis** — adversarial risks with **`riskType` badges** when Claude completes; headline fallback (`source: "headlines"`) with count-aware badge and theme-specific **Thesis gap** otherwise.
